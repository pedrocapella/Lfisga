...
var lazer_fisga= L.geoJSON(lazerz,
    {pointToLayer:fisga_lazer});
    
    function fisga_lazer(geoJSON, latlng){
        var att=geoJSON.properties;
...
var agro_fisga = L.geoJSON(agroflorestaz,{fillColor:"rgb(88, 155, 33)",fillOpacity:0.30,color:"rgb(88, 155, 33)",weight: 2,
    onEachFeature: function (feature, layer) { 
...
var eucaliptal_fisga = L.geoJSON(eucaliptalz,{fillColor:'rgb(2, 61, 25)',fillOpacity:0.30,color:'rgb(2, 61, 25)',weight: 2,
    onEachFeature: function (feature, layer) { 
...
var propextras_fisga = L.geoJSON(prop_extasz,{fillColor:"yellow",fillOpacity:0.30,color:"yellow",weight: 2,
    onEachFeature: function (feature, layer) { 
...
var galpao_compostagem_fisga = L.geoJSON(galpao_compostagemz,{fillColor:"purple",fillOpacity:0.30,color:"purple",weight: 2,
    onEachFeature: function (feature, layer) { 
        let compostagem_fisga_m2 = feature.properties.Area_M2;
        let compostagem_fisga_per = feature.properties.Perímetro;
        layer.bindPopup('<h5>Área em m2: ' + compostagem_fisga_m2 + '</h5> <h5>Perimetro (m): '+compostagem_fisga_per+'</h5>' ); 
    }});
...
var layers = {
    ...
    'Esgotos clandestinos' : esgotos_fisga,
    'Área de lazer' : lazer_fisga,
